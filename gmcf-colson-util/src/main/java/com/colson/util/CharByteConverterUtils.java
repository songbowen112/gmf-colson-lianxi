 ...
 * @version
 */
public class CharByteConverterUtils {
	...
	public static void main(String[] args) {
		...
		String str2 = "ＧＭＬＯＣ１９１１２１１４０９５３０１３";
		System.out.println(ToDBC(str2));

		String str3 = "GMLOC191121140953013";
		String s = ToDBC(str3);
		System.out.println(ToDBC(s));

		char[] chars_test1 = s.toCharArray();
