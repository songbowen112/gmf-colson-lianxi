...
public class PunchIn {
    ...
    public void setPaintRed(boolean PaintRed) {
         this.PaintRed = PaintRed;
     }
     public boolean getPaintRed() {
         return PaintRed;
     }
    ...
    public void setPunchLabel(int PunchLabel) {
         this.PunchLabel = PunchLabel;
     }
